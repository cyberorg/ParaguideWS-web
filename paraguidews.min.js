...
async function fetchWeatherData() {
	...
	// Bradbury, Tom. Meteorology and Flight. A&C Black Publishers Ltd. ISBN 0713668318.
        var cloudBaseHeight;
	if (isCelsius) { // in meters: 1000/8 m per degree celcius
	    cloudBaseHeight = Math.round((temperature - dewpt) * 125);
	} else { // in feet: 1000/4.4 ft per degree fahrenheit
            cloudBaseHeight = Math.round((temperature - dewpt) * 227.27);
        }
